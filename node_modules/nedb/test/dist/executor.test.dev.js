...
var should = require('chai').should(),
    ...
    Persistence = require('../lib/persistence'); // Test that even if a callback throws an exception, the next DB operations will still be executed
...
function testThrowInCallback(d, done) {
  ...
  process.on('uncaughtException', function (err) {// Do nothing with the error which is only there to test we stay on track
  });
  d.find({}, function (err) {
...
var testEventLoopStarvation = function testEventLoopStarvation(d, done) {
  var times = 1001;
  var i = 0;
