...
var fs = require('fs'),
    ...
    async,
    browserify,
    uglify; // Ensuring both node_modules (the source one and build one), src and out directories exist
...
ensureDirExists('node_modules');
ensureDirExists('out');
ensureDirExists('src'); // Installing build dependencies and require them
...
child_process.exec('npm install', {
  ...
  if (err) {
    console.log("Error reinstalling dependencies");
    process.exit(1);
  }
