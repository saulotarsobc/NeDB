...
(function (e) {
  if ("function" == typeof bootstrap) bootstrap("nedb", e);else if ("object" == (typeof exports === "undefined" ? "undefined" : _typeof(exports))) module.exports = e();else if ("function" == typeof define && define.amd) define(e);else if ("undefined" != typeof ses) {
    if (!ses.ok()) return;
    ses.makeNedb = e;
  ...
  return function (e, t, n) {
    ...
    3: [function (require, module, exports) {
      ...
      exports.inspect = function (obj, showHidden, depth, colors) {
        ...
        function format(value, recurseTimes) {
          ...
          var keys = showHidden ? Object_getOwnPropertyNames(value) : visible_keys; // Functions without properties can be shortcutted.
          ...
          var base, type, braces; // Determine the object type
      ...
      function isArray(ar) {
        return Array.isArray(ar) || _typeof(ar) === 'object' && Object.prototype.toString.call(ar) === '[object Array]';
      }

      function isRegExp(re) {
        _typeof(re) === 'object' && Object.prototype.toString.call(re) === '[object RegExp]';
      }
      ...
      var Object_create = Object.create || function (prototype, properties) {
        ...
        if (prototype === null) {
          ...
          if (_typeof(prototype) !== 'object') {
            throw new TypeError('typeof prototype[' + _typeof(prototype) + '] != \'object\'');
          }
    ...
    5: [function (require, module, exports) {
      ...
      Cursor.prototype._exec = function (callback) {
        ...
        if (this._sort) {
          keys = Object.keys(this._sort); // Sorting
    ...
    7: [function (require, module, exports) {
      ...
      Datastore.prototype.getCandidates = function (query) {
        var indexNames = Object.keys(this.indexes),
            usableQueryKeys; // For a basic match
      ...
      Datastore.prototype._update = function (query, updateQuery, options, cb) {
        ...
        async.waterfall([function (cb) {
          ...
          var modifiedDoc,
              ...
              modifications = []; // Preparing update (if an error is thrown here neither the datafile nor
      ...
      function Executor() {
        ...
        this.queue = async.queue(function (task, cb) {
          var callback,
              ...
              i,
              newArguments = []; // task.arguments is an array-like object on which adding a new field doesn't work, so we transform it into a real array
    ...
    10: [function (require, module, exports) {
      ...
      lastStepModifierFunctions.$push = function (obj, field, value) {
        ...
        if (value !== null && _typeof(value) === 'object' && value.$each) {
      ...
      function modify(obj, updateQuery) {
        ...
        if (dollarFirstChars.length === 0) {
          ...
          modifiers.forEach(function (m) {
            ...
            if (_typeof(updateQuery[m]) !== 'object') {
      ...
      function matchQueryPart(obj, queryKey, queryValue, treatObjAsValue) {
        ...
        if (util.isArray(objValue) && !treatObjAsValue) {
          ...
          if (queryValue !== null && _typeof(queryValue) === 'object' && !util.isRegExp(queryValue)) {
        ...
        if (queryValue !== null && _typeof(queryValue) === 'object' && !util.isRegExp(queryValue) && !util.isArray(queryValue)) {
          keys = Object.keys(queryValue);
          firstChars = _.map(keys, function (item) {
            return item[0];
          });
      ...
      */
      ...
      (function () {
        ...
        (function () {
          ...
          requirejs = require = _requireModule = function requireModule(name) {
            ...
            for (var i = 0, l = deps.length; i < l; i++) {
              if (deps[i] === 'exports') {
                ...
                reified.push(_requireModule(resolve(deps[i])));
              }
            }
        ...
        define("promise/asap", ["exports"], function (__exports__) {
          ...
          var local = typeof global !== 'undefined' ? global : this === undefined ? window : this; // node
        ...
        define("promise/utils", ["exports"], function (__exports__) {
          ...
          function objectOrFunction(x) {
            return isFunction(x) || _typeof(x) === "object" && x !== null;
          }
      ...
      (function webpackUniversalModuleDefinition(root, factory) {
        if (_typeof(exports) === 'object' && _typeof(module) === 'object') module.exports = factory();else if (typeof define === 'function' && define.amd) define([], factory);else if (_typeof(exports) === 'object') exports["localforage"] = factory();else root["localforage"] = factory();
      })(this, function () {
        return (
          /******/
          function (modules) {
          ...
          function (module, exports, __webpack_require__) {
            ...
            (function () {
              'use strict'; // Custom drivers are stored here when `defineDriver()` is called.
              ...
              var driverSupport = function (self) {
                ...
                result[DriverType.INDEXEDDB] = !!function () {
                  ...
                  try {
                    return indexedDB && typeof indexedDB.open === 'function' && // Some Samsung/HTC Android 4.0-4.3 devices
          ...
          function (module, exports) {
            ...
            (function () {
              ...
              var globalObject = this; // Initialize IndexedDB; fall back to vendor-prefixed versions if needed.

              var indexedDB = indexedDB || this.indexedDB || this.webkitIndexedDB || this.mozIndexedDB || this.OIndexedDB || this.msIndexedDB; // If IndexedDB isn't available, we get outta here!
              ...
              var supportsBlobs;
              var dbContexts; // Abstracts constructing a Blob object, so it also works in older
              ...
              function _initStorage(options) {
                ...
                dbContext.forages.push(this); // Create an array of readiness of the related localForages.
          ...
          function (module, exports, __webpack_require__) {
            ...
            (function () {
              ...
              var localStorage = null; // If the app is running inside a Google Chrome packaged webapp, or some
          ...
          function (module, exports) {
            ...
            exports.__esModule = true;
            (function () {
              'use strict'; // Sadly, the best way to save binary data in WebSQL/localStorage is serializing
              ...
              var TYPE_SERIALIZED_MARKER_LENGTH = SERIALIZED_MARKER_LENGTH + TYPE_ARRAYBUFFER.length; // Get out of our habit of using `window` inline, at least.

              var globalObject = this; // Abstracts constructing a Blob object, so it also works in older
              // browsers that don't support the native Blob constructor. (i.e.
              // old QtWebKit versions, at least).
          ...
          function (module, exports, __webpack_require__) {
            ...
            (function () {
              ...
              var globalObject = this;
              var openDatabase = this.openDatabase; // If WebSQL methods aren't available, we can stop now.
