...
(function () {
  ...
  require.register("reporters/base.js", function (module, exports, require) {
    ...
    exports.list = function (failures) {
      ...
      failures.forEach(function (test, i) {
        ...
        var err = test.err,
            ...
            actual = err.actual,
            expected = err.expected; // actual / expected diff

        if ('string' == typeof actual && 'string' == typeof expected) {
          var len = Math.max(actual.length, expected.length);
          if (len < 20) msg = errorDiff(err, 'Chars');else msg = errorDiff(err, 'Words'); // linenos
    ...
    Base.prototype.epilogue = function () {
      ...
      console.log(fmt, stats.tests || 0, pluralize(stats.tests), ms(stats.duration)); // pending
  ...
  require.register("reporters/html.js", function (module, exports, require) {
    ...
    function HTML(runner, root) {
      ...
      runner.on('test end', function (test) {
        window.scrollTo(0, document.body.scrollHeight); // TODO: add to stats
  ...
  require.register("runnable.js", function (module, exports, require) {
    ...
    Runnable.prototype.run = function (fn) {
      var self = this,
          ...
          finished,
          emitted;
      if (ctx) ctx.runnable(this); // timeout
  ...
  require.register("runner.js", function (module, exports, require) {
    ...
    Runner.prototype.runTests = function (suite, fn) {
      ...
      function next(err) {
        ...
        if (self.failures && suite._bail) return fn(); // next test
