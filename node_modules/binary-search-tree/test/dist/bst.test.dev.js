...
describe('Binary search tree', function () {
  ...
  describe('Sanity checks', function () {
    it('Can get maxkey and minkey descendants', function () {
      var t = new BinarySearchTree({
        key: 10
          ...
          l = new BinarySearchTree({
        key: 5
      }),
          r = new BinarySearchTree({
        key: 15
      }),
          ll = new BinarySearchTree({
        key: 3
      }),
          lr = new BinarySearchTree({
        key: 8
      }),
          rl = new BinarySearchTree({
        key: 11
      }),
          rr = new BinarySearchTree({
        key: 42
      });
      t.left = l;
      t.right = r;
      ...
      l.right = lr;
      r.left = rl;
      r.right = rr; // Getting min and max key descendants
      ...
      t.right.left.getMaxKeyDescendant().key.should.equal(11); // Getting min and max keys
    ...
    it('Can check that a tree verifies node ordering', function () {
      ...
      r.left = rl;
      r.right = rr;
      t.checkNodeOrdering(); // Let's be paranoid and check all cases...
  ...
  describe('Search', function () {
    ...
    it('Can search for data between two bounds', function () {
      ...
      assert.deepEqual(bst.betweenBounds({
        $gte: 8,
        $lte: 15
  ...
  describe('Deletion', function () {
    ...
    it('Able to delete leaf nodes that are non-root', function () {
      ...
      function recreateBst() {
        bst = new BinarySearchTree(); // With this insertion order the tree is well balanced
    ...
    it('Able to delete the root if it has only one child', function () {
      var bst; // Root has only one child, on the left
      ...
      bst.search(10).length.should.equal(0); // Root has only one child, on the right
  ...
  describe('Randomized test (takes much longer than the rest of the test suite)', function () {
    var bst = new BinarySearchTree(),
        data = {}; // Check a bst against a simple key => [data] object

    function checkDataIsTheSame(bst, data) {
      var bstDataElems = []; // bstDataElems is a simple array containing every piece of data in the tree
      ...
      _.reduce(_.map(data, function (d) {
        ...
        return memo + n;
      }, 0).should.equal(bstDataElems.length); // Compare data
