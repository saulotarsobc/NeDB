...
describe('AVL tree', function () {
  ...
  describe('Insertion', function () {
    ...
    it('Auto-balancing insertions', function () {
      var avlt = new AVLTree(),
          avlt2 = new AVLTree(),
          avlt3 = new AVLTree(); // Balancing insertions on the left
      ...
      avlt.tree.checkIsAVLT(); // Balancing insertions on the right
      ...
      avlt2.tree.checkIsAVLT(); // Balancing already-balanced insertions
  ...
  describe('Search', function () {
    ...
    it('Can search for data between two bounds', function () {
      ...
      assert.deepEqual(avlt.betweenBounds({
        $gte: 8,
        $lte: 15
  ...
  describe('Deletion', function () {
    ...
    it('Able to delete leaf nodes that are non-root', function () {
      var avlt; // This will create an AVL tree with leaves 3, 8, 12, 37
      ...
      avlt["delete"](12);
      avlt.checkIsAVLT();
      checkRemoved([12]); // Delete all leaves in a way that makes the tree unbalanced
    ...
    it('Able to delete the root if it has only one child', function () {
      var avlt; // Root has only one child, on the left
      ...
      avlt.search(10).length.should.equal(0); // Root has only one child, on the right
    ...
    it('Able to delete non root nodes that have only one child', function () {
      var avlt = new AVLTree(),
          ...
          secondSet = [10, 5, 15, 3, 1, 4, 20, 17, 25]; // Check that only keys in array theRemoved were removed
      ...
      avlt.checkIsAVLT();
      checkRemoved(firstSet, [3, 4, 10, 15]); // Second set: some rebalancing necessary
    ...
    it('Can delete the root if it has 2 children', function () {
      var avlt = new AVLTree(); // No rebalancing needed
      ...
      avlt.search(10).length.should.equal(0); // Rebalancing needed
    ...
    it('Can delete a non-root node that has two children', function () {
      ...
      avlt.search(5).length.should.equal(0); // On the right
  ...
  describe('Randomized test (takes much longer than the rest of the test suite)', function () {
    var avlt = new AVLTree(),
        data = {}; // Check a avlt against a simple key => [data] object

    function checkDataIsTheSame(avlt, data) {
      var avltDataElems = []; // avltDataElems is a simple array containing every piece of data in the tree
      ...
      _.reduce(_.map(data, function (d) {
        return d.length;
      }), function (memo, n) {
        return memo + n;
      }, 0).should.equal(avltDataElems.length); // Compare data
