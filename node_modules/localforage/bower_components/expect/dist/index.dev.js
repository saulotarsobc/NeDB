...
(function (global, module) {
  ...
  Assertion.prototype.empty = function () {
    ...
    if ('object' == _typeof(this.obj) && null !== this.obj && !isArray(this.obj)) {
  ...
  Assertion.prototype.a = Assertion.prototype.an = function (type) {
    if ('string' == typeof type) {
      ...
      var n = /^[aeiou]/.test(type) ? 'n' : ''; // typeof with support for 'array'

      this.assert('array' == type ? isArray(this.obj) : 'regexp' == type ? isRegExp(this.obj) : 'object' == type ? 'object' == _typeof(this.obj) && null !== this.obj : type == _typeof(this.obj), function () {
  ...
  Assertion.prototype.key = Assertion.prototype.keys = function ($keys) {
    ...
    str = (!this.flags.only ? 'include ' : 'only have ') + str; // Assertion
  ...
  var isDOMElement = function isDOMElement(object) {
    if ((typeof HTMLElement === "undefined" ? "undefined" : _typeof(HTMLElement)) === 'object') {
      ...
      return object && _typeof(object) === 'object' && object.nodeType === 1 && typeof object.nodeName === 'string';
    }
  };
  /**
   * Inspects an object.
  ...
  function i(obj, showHidden, depth) {
    ...
    function format(value, recurseTimes) {
      ...
      var $keys = showHidden ? Object.getOwnPropertyNames(value) : visible_keys; // Functions without properties can be shortcutted.
  ...
  expect.eql = function eql(actual, expected) {
    ...
    if (actual === expected) {
      ...
      return actual == expected; // If both are regular expression use the special `regExpEquiv` method
      // to determine equivalence.
    } else if (isRegExp(actual) && isRegExp(expected)) {
      return regExpEquiv(actual, expected); // 7.4. For all other Object pairs, including Array objects, equivalence is
  ...
  var json = function () {
    ...
    if ('object' == _typeof(JSON) && JSON.parse && JSON.stringify) {
      return {
...
})(void 0, 'undefined' != typeof module ? module : {
  exports: {}
});