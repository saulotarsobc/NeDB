...
var _isWebSQLValid = _interopRequireDefault(require("../utils/isWebSQLValid"));
...
function _initStorage(options) {
  ...
  var dbInfoPromise = new _promise["default"](function (resolve, reject) {
  ...
  dbInfo.serializer = _serializer["default"];
    ...
    promise = new _promise["default"](function (resolve) {
      ...
      return new _promise["default"](function (resolve, reject) {
        operationInfo.db.transaction(function (t) {
          ...
          _promise["default"].all(operations).then(function () {
            resolve();
          })["catch"](function (e) {
            reject(e);
          });
...
var webSQLStorage = {
  ...
  _support: (0, _isWebSQLValid["default"])(),
  iterate: iterate,
  getItem: getItem,
  setItem: setItem,
